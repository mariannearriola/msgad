...
from . import plotting2  # noqa: F401
...
try:
    filters.Filter.plot.__doc__ = plotting2._plot_filter.__doc__
    graphs.Graph.plot.__doc__ = plotting2._plot_graph.__doc__
    graphs.Graph.plot_spectrogram.__doc__ = plotting2._plot_spectrogram.__doc__
except AttributeError:
    # For Python 2.7.
    filters.Filter.plot.__func__.__doc__ = plotting2._plot_filter.__doc__
    graphs.Graph.plot.__func__.__doc__ = plotting2._plot_graph.__doc__
    graphs.Graph.plot_spectrogram.__func__.__doc__ = plotting2._plot_spectrogram.__doc__
