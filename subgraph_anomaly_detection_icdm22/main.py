...
#sys.path.append('../../msgad/models')
#sys.path.append('../../msgad/pygspcopy')
...
if __name__ == '__main__':
    ...
    while flag:
        ...
        for epoch in range(1, 20):
            ...
            # NOTE: precision @ k
            #threshold = np.percentile(total_error, q=(anomaly_flag.nonzero()[0].shape[0]/anomaly_flag.shape[0]))
